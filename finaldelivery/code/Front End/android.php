...
<div id="page-inner">
    ...
    <div ng-app="nghub">
        ...
        <hr><br>
        Name:<p id="demo" name="demo"></p>
        <br>
        Ram:<p id="ram" name="ram"></p>
        <br>
        Storage:<p id="storage" name="storage"></p>
...
/*	$servername = "127.0.0.1";
	...
	$db   = mysql_select_db('myproj');

 	$demo = $_POST['demo'];
        $ram = $_POST['ram'];
	$storage = $_POST['storage'];

        if(mysql_query("INSERT INTO users VALUES('4', 'h','g')"))
